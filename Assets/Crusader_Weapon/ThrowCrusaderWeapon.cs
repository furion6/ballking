...
public class ThrowCrusaderWeapon : MonoBehaviour
{
    ...
    void Update()
    {
		//if(classHolder.characterClass != CharacterClass.CRUSADER) return;
	...
	private void throwBall(){
			...
			ball.GetComponent<CrusaderWeaponController>().setPlayer(gameObject);
			ball.GetComponent<CrusaderWeaponController>().setCamera(camera);
