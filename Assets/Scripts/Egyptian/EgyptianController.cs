...
public class EgyptianController : MonoBehaviour, PlayerControllerInterface
{
...
//FIXME REFACTOR
    ...
    public void release() {
        ...
        ball.GetComponent<EgyptianBallController>().setPlayer(gameObject);
        ball.GetComponent<EgyptianBallController>().setCamera(camera);
