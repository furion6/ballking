...
public class ThrowGrenade : MonoBehaviour
{
    ...
    void Update()
    {
		//if(classHolder.characterClass != CharacterClass.GRENADIER) return;
	...
	private void throwBall(){
			...
			ball.GetComponentInChildren<GrenadeController>().setPlayer(gameObject);
			ball.GetComponentInChildren<GrenadeController>().setCamera(camera);
